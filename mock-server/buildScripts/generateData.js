...
const compiledBasicCustomerSchema = json_schema_faker_1.JSONSchemaFaker.generate(
  basicCustomerSchema_1.basicCustomerSchema,
)
const compiledLeadSchema = json_schema_faker_1.JSONSchemaFaker.generate(leadSchema_1.leadSchema)
const compiledCombinedSchema = (0, helper_1.combineSchema)(
  compiledBasicCustomerSchema,
  compiledLeadSchema,
)
